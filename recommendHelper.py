import os
# emotion mapping for spotify search
# adapted from emotify-app
...
# generate a recommendation url to pass to spotify
def generateRecommendURL(emotion, seedArtist, seedTrack, limit):
    min_d = emotionMapping[emotion]["min_danceability"];
    max_d = emotionMapping[emotion]["max_danceability"];
    min_e = emotionMapping[emotion]["min_energy"];
